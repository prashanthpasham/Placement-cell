...
<div class="col-md-12">
  <div class="row">
	...
	<div class="col-md-8">
    <h3><center>Automated Generated Resume</center></h3>
    <div class="well">
<!--
   <div class="col-md-8"> 
   -->
...
<div class="thumbnail" style="width:150px;height:150px;float:right;margin-top:-145px">
 <img src="<?php echo base_url('uploads/'.$resume['image']); ?>" width="150"height="150" alt="photo not uploaded">
...
<div class="col-md-12">
  ...
  <a href="<?php echo site_url('Userpage/addobjective/'.$resume['rollno']); ?>"  class="btn btn-success"><i class="glyphicon glyphicon-plus"></i>Add Objective</a>
  <a href="<?php echo site_url('Userpage/editobjective/'.$resume['rollno']); ?>"  class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i>Edit Objective</a>  
</div>
      <div class="well">
