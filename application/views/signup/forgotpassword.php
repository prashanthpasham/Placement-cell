...
<div id="mhead"><h2>Placement Hub</h2>
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="col-md-4">
           ...
           <?php echo form_open('signup/forgotpassword',array("class"=>"form-horizontal")); ?>
				<a href="#" class="list-group-item">
					<center><h4>Reset Your Password!</h4></center>

					<?php echo validation_errors(); ?>
				
			<input type="email" class="form-control" id="password" value="<?php echo $this->input->post('email'); ?>" name="email" placeholder="Enter your email" required><br>
